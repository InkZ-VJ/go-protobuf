...
func (x *RateLaptopRequset) Reset() {
	*x = RateLaptopRequset{}
	if protoimpl.UnsafeEnabled {
...
func (x *RateLaptopRequset) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RateLaptopRequset) ProtoMessage() {}

func (x *RateLaptopRequset) ProtoReflect() protoreflect.Message {
	mi := &file_laptop_service_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RateLaptopRequset.ProtoReflect.Descriptor instead.
func (*RateLaptopRequset) Descriptor() ([]byte, []int) {
	return file_laptop_service_proto_rawDescGZIP(), []int{7}
}

func (x *RateLaptopRequset) GetLaptopId() string {
	if x != nil {
		return x.LaptopId
	}
	return ""
...
func (x *RateLaptopRequset) GetScore() float64 {
	if x != nil {
		return x.Score
	}
	return 0
...
var file_laptop_service_proto_rawDesc = []byte{
	...
	0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x52, 0x65, 0x71, 0x75, 0x73, 0x65, 0x74, 0x12, 0x1b, 0x0a,
	...
	0x61, 0x74, 0x65, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x52, 0x65, 0x71, 0x75, 0x73, 0x65, 0x74,
	...
	0x5a, 0x0c, 0x74, 0x65, 0x63, 0x68, 0x2d, 0x67, 0x52, 0x50, 0x43, 0x2f, 0x70, 0x62, 0x62, 0x06,
...
var file_laptop_service_proto_goTypes = []interface{}{
	...
	(*RateLaptopRequset)(nil),    // 7: pb.RateLaptopRequset
...
var file_laptop_service_proto_depIdxs = []int32{
	...
	7,  // 7: pb.LaptopService.RateLaptop:input_type -> pb.RateLaptopRequset
...
func file_laptop_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_laptop_service_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RateLaptopRequset); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
