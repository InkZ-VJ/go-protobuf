...
func (x *laptopServiceRateLaptopClient) Send(m *RateLaptopRequset) error {
	return x.ClientStream.SendMsg(m)
}
...
func (x *laptopServiceRateLaptopServer) Recv() (*RateLaptopRequset, error) {
	m := new(RateLaptopRequset)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
