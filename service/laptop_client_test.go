...
func requireSameLaptop(t *testing.T, laptop1, laptop2 *pb.Laptop) {
	...
	// not work because other field may not be similar like ID

	// serialize first
	json1 := serialize.ProtobufToJSON(laptop1)
	json2 := serialize.ProtobufToJSON(laptop2)
